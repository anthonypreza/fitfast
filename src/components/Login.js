			...
			.then((providers) => {
				if (providers.length === 0) {
					...
					firebase
						...
						.then((usercred) => console.log('Account linking success', usercred.user))
		...
		return (
			<div className="container">
				...
				<h4 className="center section light">
					Get fit faster! Upload and save routines, edit individual exercises, track progress, and much more.
				</h4>
					...
					>
						<div className="row">
							<div className="col s12">
								<h6>If you don't have an account already, this form will create your account.</h6>
							</div>
